...
public abstract class UniverseDefinitionTaskBase extends UniverseTaskBase {
   ...
   * @param nodes the nodes on which the filters are applied.
   ...
   */
  public boolean filterNodesByStatus(
      Universe universe,
        ...
        nodes
            ...
            .map(
                node -> {
                  ...
                  NodeDetails nodeInUniverse = nodesMap.get(nodeName);
            ...
            .filter(
                node -> {
                  ...
                  log.info(
                      ...
                      currentNodeStatus,
                      node.getNodeName());
                  return skipNodeStatusCheck || currentNodeStatus.equalsIgnoreNull(nodeStatus);
                })
