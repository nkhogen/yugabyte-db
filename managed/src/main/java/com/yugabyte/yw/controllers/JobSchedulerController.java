...
public class JobSchedulerController extends AuthenticatedController {
  ...
  @ApiImplicitParams(
      @ApiImplicitParam(
          name = "JobScheduleUpdateForm",
          paramType = "body",
          dataType = "com.yugabyte.yw.forms.JobScheduleUpdateForm",
          required = true))
  @AuthzPath({
    @RequiredPermissionOnResource(
        requiredPermission =
  ...
  @ApiOperation(
      notes = "WARNING: This is a preview API that could change.",
      value = "Snooze Job Schedule",
      response = JobScheduleResp.class,
      hidden = true,
      nickname = "SnoozeobSchedule")
  @ApiImplicitParams(
      @ApiImplicitParam(
          name = "JobScheduleSnoozeForm",
          paramType = "body",
          dataType = "com.yugabyte.yw.forms.JobScheduleSnoozeForm",
          required = true))
  @AuthzPath({
    @RequiredPermissionOnResource(
        requiredPermission =
  ...
  @YbaApi(visibility = YbaApi.YbaApiVisibility.PREVIEW, sinceYBAVersion = "2024.2.1.0")
  public Result snoozeJobSchedule(UUID customerUuid, UUID jobScheduleUuid, Http.Request request) {
    JobScheduleSnoozeForm payload = parseJsonAndValidate(request, JobScheduleSnoozeForm.class);
    JobScheduleResp response =
        jobSchedulerHandler.snoozeJobSchedule(customerUuid, jobScheduleUuid, payload);
    auditService()
        .createAuditEntry(
            request,
            Audit.TargetType.JobSchedule,
